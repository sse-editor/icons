...
```sh
npm install @sse-editor/icons

yarn add @sse-editor/icons
```

And import required icons.

```js
import { IconH1 } from "@sse-editor/icons";
...
- Request an icon you need via [an Issue](https://github.com/sse-editor/icons/issues/new)
